...
public class HelloAction extends ActionSupport {
	...
	public String fileExcel() throws IOException {
		String filePath = servletRequest.getServletContext().getRealPath("/images");
		File fileToCreate = new File(filePath, uploadedFileName);
	 ...
	 * if(filename.toLowerCase().endsWith("xls")){ return new HSSFWorkbook(is); }
	 * if(filename.toLowerCase().endsWith("xlsx")){ return new XSSFWorkbook(is); }
	 * return null; }
	 */
	...
	/*
	 * public String loginNameAndEmail() throws SQLException, IOException { Reader
	 * reader = Resources.getResourceAsReader("SqlMapConfig.xml"); SqlSessionFactory
	 * sqlSessionFactory = new SqlSessionFactoryBuilder().build(reader); SqlSession
	 * session = sqlSessionFactory.openSession();
	 * 
	 * // Print the student details student = session.selectOne("Student.getLogin",
	 * loginAction());
	 * 
	 * System.out.println(student.getName());
	 * System.out.println(student.getEmail());
